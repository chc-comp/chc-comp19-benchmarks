...
(assert (forall ((excludes9.excludes Bool)
  ...
  (let ((a!1 (and (and (and (not excludes9.X1) (not excludes9.X2))
                  ...
                  (not excludes9.X8)
                  (not excludes9.X9)))
        (a!2 (and (and (and (not excludes9.X1) (not excludes9.X2))
                       (not excludes9.X3))
                  (not excludes9.X4))))
  (let ((a!3 (and (and (and a!2 (not excludes9.X5)) (not excludes9.X6))
                  excludes9.X7
                  (not excludes9.X8)
                  (not excludes9.X9)))
        (a!4 (and (and (and a!2 (not excludes9.X5)) (not excludes9.X6))
                  (not excludes9.X7))))
  (let ((a!5 (or (not excludes9.X1)
                 (and (not excludes9.X2)
                      (not excludes9.X3)
                      (not excludes9.X4)
                      (not excludes9.X5)
                      (not excludes9.X6)
                 ...
                 (and a!2
                      ...
                      (not excludes9.X8)
                      (not excludes9.X9))
                 (and (and a!2 (not excludes9.X5))
                      excludes9.X6
                      (not excludes9.X7)
                      (not excludes9.X8)
                      (not excludes9.X9))
                 a!3
                 (and a!4 excludes9.X8 (not excludes9.X9))
                 (and a!4 (not excludes9.X8) excludes9.X9))))
...
(assert (forall ((top.e1 Bool)
         ...
         (top.OK Bool))
  (let ((a!1 (and (excludes9_fun top.e1
                                 top.e2
                                 top.e3
                                 top.e4
                                 top.e5
