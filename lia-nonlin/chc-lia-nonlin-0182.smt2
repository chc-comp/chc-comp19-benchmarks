...
(declare-fun MAIN
             (Int Int Bool Bool Int Int Int Int Int Int Bool Bool Bool Bool)
             Bool)
...
(assert (forall ((DRAGON.__DRAGON_2_m Int)
         ...
         (DRAGON.ni_6._arrow._first_m Bool)
         (DRAGON.ni_6._arrow._first_c Bool))
...
(assert (forall ((DRAGON.g11 Bool)
         ...
         (DRAGON.ni_6._arrow._first_x Bool)
  ...
  (let ((a!68 (and (= DRAGON.g11 (>= DRAGON.__DRAGON_4_c 1))
                   ...
                   (= DRAGON.g02 a!1)
                   (= DRAGON.ni_6._arrow._first_m DRAGON.ni_6._arrow._first_c)
                   (= DRAGON.__DRAGON_1
                      (ite DRAGON.ni_6._arrow._first_m true false))
...
(assert (forall ((top.__top_3_m Int)
         ...
         (top.ni_3.Sofar.ni_4._arrow._first_c Bool)
         (top.ni_3.Sofar.__Sofar_2_m Bool)
         (top.ni_3.Sofar.ni_4._arrow._first_m Bool)
         (top.ni_2.DRAGON.__DRAGON_2_c Int)
         (top.ni_2.DRAGON.__DRAGON_3_c Int)
         (top.ni_2.DRAGON.__DRAGON_4_c Int)
         (top.ni_2.DRAGON.__DRAGON_5_c Int)
         (top.ni_2.DRAGON.__DRAGON_6_c Int)
         (top.ni_2.DRAGON.__DRAGON_8_c Int)
         (top.ni_2.DRAGON.ni_6._arrow._first_c Bool)
         (top.ni_2.DRAGON.__DRAGON_2_m Int)
         (top.ni_2.DRAGON.__DRAGON_3_m Int)
         (top.ni_2.DRAGON.__DRAGON_4_m Int)
         (top.ni_2.DRAGON.__DRAGON_5_m Int)
         (top.ni_2.DRAGON.__DRAGON_6_m Int)
         (top.ni_2.DRAGON.__DRAGON_8_m Int)
         (top.ni_2.DRAGON.ni_6._arrow._first_m Bool)
...
(assert (forall ((top.e01 Bool)
         ...
         (top.ni_3.Sofar.ni_4._arrow._first_x Bool)
         (top.ni_2.DRAGON.__DRAGON_2_m Int)
         (top.ni_2.DRAGON.__DRAGON_2_c Int)
         (top.ni_2.DRAGON.__DRAGON_3_m Int)
         (top.ni_2.DRAGON.__DRAGON_3_c Int)
         ...
         (top.invalid Int)
         (top.erreur Bool)
         (top.ni_2.DRAGON.__DRAGON_2_x Int)
         (top.ni_2.DRAGON.__DRAGON_3_x Int)
         (top.ni_2.DRAGON.__DRAGON_4_x Int)
         (top.ni_2.DRAGON.__DRAGON_5_x Int)
         (top.ni_2.DRAGON.__DRAGON_6_x Int)
         (top.ni_2.DRAGON.__DRAGON_8_x Int)
         (top.ni_2.DRAGON.ni_6._arrow._first_x Bool)
         (top.ni_1._arrow._first_m Bool)
         (top.ni_1._arrow._first_c Bool)
         (top.__top_2 Bool)
  ...
  (let ((a!1 (or (not (= top.__top_2 false))
                 (= top.__top_4
                    (= (+ top.exclusive
                          ...
                          top.invalid)
                       top.__top_3_c))))
        (a!2 (and (=> top.env (not top.erreur))
                  (=> top.env top.__top_4)
                  (=> top.env
                      (= (+ top.exclusive
                            top.shared
                         ...
                         top.__top_1))
                  (=> top.env (<= top.dirty 1))
                  (=> top.env (and (< top.dirty 1) (< top.shared 1)))
                  (=> top.env (>= top.shared 0))
                  (=> top.env (>= top.exclusive 0))
                  (=> top.env (>= top.shared_dirty 0))
                  (=> top.env (>= top.dirty 0))
                  (=> top.env (>= top.invalid 0))
                  (=> top.env (<= top.shared top.__top_1))
                  (=> top.env (<= top.shared_dirty top.__top_1))
                  (=> top.env (<= top.dirty top.__top_1))
                  (=> top.env (<= top.invalid top.__top_1)))))
  (let ((a!3 (and (excludes12_fun top.e01
                                  top.e02
                                  top.e03
                                  top.e04
                                  top.e05
                  ...
                  (= top.ni_2.DRAGON.__DRAGON_2_m top.ni_2.DRAGON.__DRAGON_2_c)
