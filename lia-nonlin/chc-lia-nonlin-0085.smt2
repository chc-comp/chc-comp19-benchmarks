...
(assert (forall ((top.ni_0._arrow._first_m Bool)
         ...
         (top.__top_6_x Int)
         (top.__top_5_x Int))
  (let ((a!1 (not (= (and top.a (< top.pre_y 10)) true)))
        (a!2 (not (= (and top.a (< top.pre_y 10)) false)))
        (a!4 (or (not (= (or top.b top.c) true)) (= top.x 0)))
        (a!5 (not (= (and top.a (< top.pre_x 15)) true)))
        (a!6 (not (= (and top.a (< top.pre_x 15)) false))))
