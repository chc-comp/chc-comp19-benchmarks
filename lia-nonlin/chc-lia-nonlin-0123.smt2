...
(declare-fun top_reset
             (Bool Bool Int Int Int Int Bool Bool Bool Int Int Int Int Bool)
             Bool)
...
(assert (forall ((mesi.__mesi_2_m Int)
         ...
         (mesi.__mesi_5_m Int)
         (mesi.__mesi_5_c Int)
         (mesi.ni_2._arrow._first_m Bool)
         (mesi.ni_2._arrow._first_c Bool))
...
(assert (forall ((mesi.garde_me4 Bool)
         ...
         (mesi.ni_2._arrow._first_c Bool)
         (mesi.__mesi_1 Bool)
         (mesi.ni_2._arrow._first_x Bool)
         (mesi.etat_me1 Bool)
         (mesi.etat_me2 Bool)
         (mesi.etat_me3 Bool)
         (mesi.etat_me4 Bool)
  ...
  (let ((a!1 (and (= mesi.shared_me mesi.__mesi_3_c)
        ...
        (a!10 (and (= mesi.shared_me
                      (- (+ mesi.__mesi_3_c mesi.__mesi_4_c mesi.__mesi_5_c) 1))
                   (= mesi.modified_me 0)
  ...
  (let ((a!3 (and (or (not (= mesi.garde_me4 false)) a!1)
        ...
        (a!11 (and (or (not (= mesi.garde_me1 false)) a!1)
                   (or (not (= mesi.garde_me1 true)) a!10))))
  ...
  (let ((a!12 (and (or (not (= mesi.etat_me1 false)) a!9)
                   (or (not (= mesi.etat_me1 true)) a!11))))
  (let ((a!13 (and (= mesi.garde_me4 (>= mesi.__mesi_2_c 1))
                   (= mesi.garde_me3 (>= mesi.__mesi_3_c 1))
                   (= mesi.garde_me2 (>= mesi.__mesi_4_c 1))
                   (= mesi.garde_me1 (>= mesi.__mesi_2_c 1))
                   (= mesi.ni_2._arrow._first_m mesi.ni_2._arrow._first_c)
                   (= mesi.__mesi_1 (ite mesi.ni_2._arrow._first_m true false))
                   (= mesi.ni_2._arrow._first_x false)
                   (or (not (= mesi.__mesi_1 false)) a!12)
...
(assert (forall ((top.ni_1.mesi.__mesi_2_c Int)
         (top.ni_1.mesi.__mesi_3_c Int)
         (top.ni_1.mesi.__mesi_4_c Int)
         (top.ni_1.mesi.__mesi_5_c Int)
         (top.ni_1.mesi.ni_2._arrow._first_c Bool)
         (top.ni_1.mesi.__mesi_2_m Int)
         (top.ni_1.mesi.__mesi_3_m Int)
         (top.ni_1.mesi.__mesi_4_m Int)
         (top.ni_1.mesi.__mesi_5_m Int)
         (top.ni_1.mesi.ni_2._arrow._first_m Bool)
  ...
  (=> (and (mesi_reset top.ni_1.mesi.__mesi_2_c
      ...
      (top_reset top.ni_0.Sofar.__Sofar_2_c
                 ...
                 top.ni_1.mesi.__mesi_5_m
                 top.ni_1.mesi.ni_2._arrow._first_m))))
(assert (forall ((top.ni_1.mesi.__mesi_2_m Int)
         (top.ni_1.mesi.__mesi_2_c Int)
         (top.ni_1.mesi.__mesi_3_m Int)
         (top.ni_1.mesi.__mesi_3_c Int)
         (top.ni_1.mesi.__mesi_4_m Int)
         (top.ni_1.mesi.__mesi_4_c Int)
         ...
         (top.shared_me Int)
         (top.invalid_me Int)
         (top.ni_1.mesi.__mesi_2_x Int)
         (top.ni_1.mesi.__mesi_3_x Int)
         (top.ni_1.mesi.__mesi_4_x Int)
         (top.ni_1.mesi.__mesi_5_x Int)
         (top.ni_1.mesi.ni_2._arrow._first_x Bool)
         (top.__top_1 Bool)
         (top.ni_0.Sofar.__Sofar_2_m Bool)
         (top.ni_0.Sofar.__Sofar_2_c Bool)
         (top.ni_0.Sofar.ni_3._arrow._first_m Bool)
         ...
         (top.OK Bool))
  (let ((a!1 (= top.OK (=> top.env (not (> top.modified_me 2))))))
  (let ((a!2 (and (= top.ni_1.mesi.__mesi_2_m top.ni_1.mesi.__mesi_2_c)
