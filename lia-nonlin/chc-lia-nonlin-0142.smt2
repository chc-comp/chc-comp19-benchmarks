...
(declare-fun top_reset
             (Int Int Int Int Bool Bool Bool Int Int Int Int Bool Bool Bool)
             Bool)
...
(assert (forall ((synapse.__synapse_2_m Int)
         ...
         (synapse.ni_2._arrow._first_m Bool)
         (synapse.ni_2._arrow._first_c Bool))
...
(assert (forall ((synapse.garde_s3 Bool)
         ...
         (synapse.ni_2._arrow._first_x Bool)
         (synapse.e_s1 Bool)
         (synapse.valid_s Int)
         (synapse.e_s2 Bool)
         (synapse.e_s3 Bool)
  ...
  (let ((a!14 (and (= synapse.garde_s3 (>= synapse.__synapse_4_c 1))
                   ...
                   (= synapse.ni_2._arrow._first_m synapse.ni_2._arrow._first_c)
                   (= synapse.__synapse_1
                      (ite synapse.ni_2._arrow._first_m true false))
...
(assert (forall ((top.ni_1.Sofar.__Sofar_2_c Bool)
         ...
         (top.ni_0.synapse.__synapse_2_c Int)
         (top.ni_0.synapse.__synapse_3_c Int)
         (top.ni_0.synapse.__synapse_4_c Int)
         (top.ni_0.synapse.__synapse_5_c Int)
         (top.ni_0.synapse.ni_2._arrow._first_c Bool)
         (top.ni_0.synapse.__synapse_2_m Int)
         (top.ni_0.synapse.__synapse_3_m Int)
         (top.ni_0.synapse.__synapse_4_m Int)
         (top.ni_0.synapse.__synapse_5_m Int)
         (top.ni_0.synapse.ni_2._arrow._first_m Bool))
...
(assert (forall ((top.e_s1 Bool)
         ...
         (top.dirty_s Int)
         (top.mem_init_s Int)
         (top.ni_0.synapse.__synapse_2_x Int)
         (top.ni_0.synapse.__synapse_3_x Int)
         (top.ni_0.synapse.__synapse_4_x Int)
         (top.ni_0.synapse.__synapse_5_x Int)
         (top.ni_0.synapse.ni_2._arrow._first_x Bool)
         (top.OK Bool))
  (let ((a!1 (= top.OK (=> top.env (or (< top.dirty_s 1) (< top.valid_s 1))))))
  (let ((a!2 (and (excludes3_fun top.e_s1 top.e_s2 top.e_s3 top.__top_1)
...
(assert (forall ((top.ni_0.synapse.__synapse_2_c Int)
         (top.ni_0.synapse.__synapse_3_c Int)
         (top.ni_0.synapse.__synapse_4_c Int)
         (top.ni_0.synapse.__synapse_5_c Int)
         (top.ni_0.synapse.ni_2._arrow._first_c Bool)
  ...
  (=> (and INIT_STATE
           ...
           (top_step top.e_s1
                     ...
                     top.ni_1.Sofar.__Sofar_2_x
                     top.ni_1.Sofar.ni_3._arrow._first_x))
      (MAIN top.ni_0.synapse.__synapse_2_x
            top.ni_0.synapse.__synapse_3_x
            top.ni_0.synapse.__synapse_4_x
            top.ni_0.synapse.__synapse_5_x
            top.ni_0.synapse.ni_2._arrow._first_x
...
(assert (forall ((top.ni_0.synapse.__synapse_2_c Int)
         ...
         (top.ni_1.Sofar.__Sofar_2_x Bool)
         (top.ni_1.Sofar.ni_3._arrow._first_x Bool))
  (=> (and (MAIN top.ni_0.synapse.__synapse_2_c
                 top.ni_0.synapse.__synapse_3_c
                 top.ni_0.synapse.__synapse_4_c
                 top.ni_0.synapse.__synapse_5_c
                 top.ni_0.synapse.ni_2._arrow._first_c
