...
(assert (forall ((DRAGON.__DRAGON_2_m Int)
         ...
         (DRAGON.ni_4._arrow._first_m Bool)
         (DRAGON.ni_4._arrow._first_c Bool))
...
(assert (forall ((DRAGON.g11 Bool)
         ...
         (DRAGON.ni_4._arrow._first_x Bool)
  ...
  (let ((a!68 (and (= DRAGON.g11 (>= DRAGON.__DRAGON_4_c 1))
                   ...
                   (= DRAGON.g02 a!1)
                   (= DRAGON.ni_4._arrow._first_m DRAGON.ni_4._arrow._first_c)
                   (= DRAGON.__DRAGON_1
                      (ite DRAGON.ni_4._arrow._first_m true false))
...
(assert (forall ((top.__top_2_m Int)
         ...
         (top.ni_1.DRAGON.ni_4._arrow._first_c Bool)
         ...
         (top.ni_1.DRAGON.ni_4._arrow._first_m Bool)
...
(assert (forall ((top.e01 Bool)
         ...
         (top.ni_1.DRAGON.ni_4._arrow._first_x Bool)
         (top.ni_0._arrow._first_m Bool)
         (top.ni_0._arrow._first_c Bool)
         (top.__top_1 Bool)
