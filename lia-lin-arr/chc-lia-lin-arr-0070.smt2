...
(assert (forall ((@nondet_int_0 Int) (@nondet_char_0 Int))
  (=> true (main@entry @nondet_int_0 @nondet_char_0))))
...
(assert (forall ((main@%shadow.mem1.0_0 (Array Int Int))
         ...
         (main@%tmp92.i_0 Int)
         (main@%tmp93.i_0 Bool)
         (\\\\\tuple(main@bb76.i_0, main@bb98.i_0)\\\\\ Bool)
         (\\\\\tuple(main@bb64.i_0, main@bb98.i_0)\\\\\ Bool)
         (main@bb98.i_0 Bool)
         (main@%tmp100.i_0 Int)
         (main@bb59.i_1 Bool)
         (main@%i.1.i_1 Int)
  ...
  (let ((a!6 (and (main@bb59.i main@%shadow.mem1.0_0
                  ...
                  (=> \\\\\tuple(main@bb76.i_0, main@bb98.i_0)\\\\\
                      main@bb76.i_0)
                  (=> \\\\\tuple(main@bb64.i_0, main@bb98.i_0)\\\\\
                      main@bb64.i_0)
                  (=> main@bb98.i_0
