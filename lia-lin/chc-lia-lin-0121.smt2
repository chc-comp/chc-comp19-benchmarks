...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!1 (= (not (or (and param_e_s2__AT0 param_e_s1__AT0)
                         (and param_e_s1__AT0 param_e_s3__AT0)
                         (and param_e_s2__AT0 param_e_s3__AT0)))
        ...
        (a!2 (= (+ call_First.First__AT0
                   ...
                   (* (- 1) invalid_s__AT0))
                0))
        (a!3 (= (or (not env__AT0) (not (<= 2 dirty_s__AT0))) _R1___AT0)))
  (let ((a!4 (and (= call_First.flby__AT0 call_First.First__AT0)
...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!1 (= (not (or (and param_e_s2__AT0 param_e_s1__AT0)
        ...
        (a!2 (= (+ call_First.First__AT0
                ...
                0))
        (a!3 (= (or (not env__AT0) (not (<= 2 dirty_s__AT0))) _R1___AT0))
        (a!4 (= (not (or (and param_e_s1__AT1 param_e_s2__AT1)
                         (and param_e_s1__AT1 param_e_s3__AT1)
                         (and param_e_s2__AT1 param_e_s3__AT1)))
                call_excludes3.excludes__AT1))
        (a!5 (+ (* (- 1) dirty_s__AT1)
                (* (- 1) valid_s__AT1)
                (* (- 1) invalid_s__AT1)))
        (a!7 (= (or (not env__AT1) (not (<= 2 dirty_s__AT1))) _R1___AT1))
        (a!8 (= (+ call_synapse.valid_s__AT0 (* (- 1) call_synapse.xite7__AT1))
                (- 1)))
        (a!9 (= (+ call_synapse.dirty_s__AT0
                ...
                1))
        (a!10 (= (+ call_synapse.dirty_s__AT0
                    call_synapse.valid_s__AT0
                    call_synapse.invalid_s__AT0
                    (* (- 1) call_synapse.xite2__AT1))
                 0))
        (a!11 (= (+ call_synapse.dirty_s__AT0
                    (* (- 1) call_synapse.invalid_s__AT0)
                    call_synapse.xite__AT1)
                 (- 1))))
  (let ((a!6 (= (or (= (+ call_First.First__AT1 a!5) 0) (not env__AT1))
                _R3___AT1)))
  (let ((a!12 (and (state call_First.flby__AT0
                          call_First.First__AT0
                          call_Sofar.flby__AT0
                          call_Sofar.Sofar__AT0
                          param_e_s2__AT0
                   ...
                   (= flby__AT1
                      (= (+ dirty_s__AT0 valid_s__AT0 invalid_s__AT0 a!5) 0)))))
    (=> a!12
