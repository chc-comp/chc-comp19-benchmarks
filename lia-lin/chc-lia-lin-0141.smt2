...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!1 (= (not (or (and param_etat_mo4__AT0 param_etat_mo3__AT0)
        ...
        (a!2 (= (or (and (not erreur_mo__AT0) flby__AT0) (not env__AT0))
                _OK___AT0)))
    (=> (and (= call_Sofar.flby__AT0 call_Sofar.Sofar__AT0)
             ...
             (or (= call_moesi.xite31__AT0 0) (not call_moesi.garde_mo4__AT0))
             (or (not call_moesi.garde_mo4__AT0) (= call_moesi.xite19__AT0 0))
             (or (not call_moesi.garde_mo4__AT0) (= call_moesi.xite4__AT0 0))
             (or (not call_moesi.garde_mo4__AT0) (= call_moesi.xite12__AT0 1))
             (or (= call_moesi.xite30__AT0 0) (not call_moesi.garde_mo3__AT0))
             (or (not call_moesi.garde_mo3__AT0) (= call_moesi.xite18__AT0 0))
             (or (not call_moesi.garde_mo3__AT0) (= call_moesi.xite3__AT0 0))
             (or (not call_moesi.garde_mo3__AT0) (= call_moesi.xite11__AT0 1))
             (or (= call_moesi.xite__AT0 0) (not call_moesi.garde_mo1__AT0))
             (or (not call_moesi.garde_mo1__AT0) (= call_moesi.xite9__AT0 0))
             flby__AT0
...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!1 (= (not (or (and param_etat_mo4__AT0 param_etat_mo3__AT0)
        ...
        (a!2 (= (or (and (not erreur_mo__AT0) flby__AT0) (not env__AT0))
                _OK___AT0))
        (a!3 (= (not (or (and param_etat_mo3__AT1 param_etat_mo4__AT1)
        ...
        (a!4 (= (or (and (not erreur_mo__AT1) flby__AT1) (not env__AT1))
                _OK___AT1))
        ...
        (a!12 (= (+ owned_mo__AT0
                    ...
                    (* (- 1) modified_mo__AT1))
                 0)))
  (let ((a!13 (and (state call_Sofar.flby__AT0
                          call_Sofar.Sofar__AT0
                          param_etat_mo4__AT0
                          param_etat_mo3__AT0
                          param_etat_mo2__AT0
