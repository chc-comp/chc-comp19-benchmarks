...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!2 (and (and (and a!1 (not param_e05__AT0)) (not param_e06__AT0))
        ...
        (a!5 (and (not param_e12__AT0)
                  ...
                  param_e07__AT0))
        (a!9 (= (or (and (<= 0 exclusive__AT0) (not erreur__AT0) flby__AT0 a!8)
                    (not env__AT0))
                _OK___AT0)))
  ...
  (let ((a!11 (and (= call_First.flby__AT0 call_First.First__AT0)
                   ...
                   (or (not param_e04__AT0)
                       (= call__DRAGON_.xite34__AT0 call__DRAGON_.xite43__AT0))
                   (or param_e04__AT0
                   ...
                   (or (not param_e03__AT0)
                       (= call__DRAGON_.xite33__AT0 call__DRAGON_.xite44__AT0))
                   (or param_e03__AT0
...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!1 (and (and (and (not param_e02__AT0) (not param_e01__AT0))
        ...
        (a!21 (and (<= 1 call__DRAGON_.invalid__AT0)
        ...
        (a!30 (= (+ call__DRAGON_.shared__AT0
                 ...
                 1))
        (a!31 (= (+ call__DRAGON_.shared_dirty__AT0
                    call__DRAGON_.shared__AT0
                    (* (- 1) call__DRAGON_.xite14__AT1))
                 1))
        (a!32 (= (+ call__DRAGON_.dirty__AT0
                    call__DRAGON_.shared_dirty__AT0
                    call__DRAGON_.shared__AT0
                    call__DRAGON_.exclusive__AT0
                    (* (- 1) call__DRAGON_.xite15__AT1))
                 0))
        (a!33 (= (+ call__DRAGON_.shared__AT0
                    call__DRAGON_.exclusive__AT0
                    (* (- 1) call__DRAGON_.xite12__AT1))
                 (- 1)))
        (a!34 (= (+ call__DRAGON_.exclusive__AT0
  ...
  (let ((a!2 (and (and (and a!1 (not param_e05__AT0)) (not param_e06__AT0))
        ...
        (a!14 (and (not param_e12__AT1)
                   ...
                   param_e07__AT1))
        (a!18 (or (and (<= 0 exclusive__AT1)
                       (not erreur__AT1)
                       flby__AT1
                       (= (+ call_First.First__AT1 a!17) 0))
                  (not env__AT1))))
  (let ((a!3 (and (and (and a!2 (not param_e08__AT0)) (not param_e09__AT0))
                  (not param_e10__AT0)))
        (a!6 (and (not param_e12__AT0)
  ...
  (let ((a!45 (and (state call_First.flby__AT0
                          call_First.First__AT0
                          call_Sofar.flby__AT0
                          call_Sofar.Sofar__AT0
                          param_e02__AT0
                   ...
                   (or param_e04__AT1
                       (= call__DRAGON_.xite29__AT1 call__DRAGON_.xite30__AT1))
                   ...
                   (or param_e04__AT1
                       (= call__DRAGON_.xite43__AT1 call__DRAGON_.xite42__AT1))
                   (or param_e03__AT1
                       (= call__DRAGON_.xite8__AT1 call__DRAGON_.xite9__AT1))
                   ...
                   (or a!27 (not call__DRAGON_.g03__AT1))
                   (or call__DRAGON_.g11__AT1
                       (= call__DRAGON_.shared_dirty__AT0
                          call__DRAGON_.xite26__AT1))
                   (or a!28 (not call__DRAGON_.g11__AT1))
                   (or call__DRAGON_.g08__AT1
                       (= call__DRAGON_.shared_dirty__AT0
