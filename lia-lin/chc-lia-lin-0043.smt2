...
(assert (forall ((state.success!0 Bool)
         ...
         (state.pc!1 Int)
         (state.state Int))
  (let ((a!1 (and (invariant state.success!0
                             state.success!1
                             state.value!0
                             state.value!1
                             state.state_read!0
