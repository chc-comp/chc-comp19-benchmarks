...
(assert (forall ((J Int)
         ...
         (K Int)
         (L Int))
  (=> (and (= J 0) (h1 A B C D E F G H I M K L)) (h2 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((H Int)
         ...
         (K Int)
         (L Int))
  (=> (and (= H 1) (h3 A B C D E F G H I J K L)) (h4 A B C D E F G H I J K L))))
(assert (forall ((K Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (M Int)
         (L Int))
  (=> (and (= K 1) (h4 A B C D E F G H I J M L)) (h5 A B C D E F G H I J K L))))
(assert (forall ((H Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (K Int)
         (L Int))
  (=> (and (<= H 0) (h3 A B C D E F G H I J K L)) (h6 A B C D E F G H I J K L))))
(assert (forall ((K Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (M Int)
         (L Int))
  (=> (and (= K 2) (h6 A B C D E F G H I J M L)) (h7 A B C D E F G H I J K L))))
(assert (forall ((H Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (K Int)
         (L Int))
  (=> (and (>= H 2) (h3 A B C D E F G H I J K L)) (h8 A B C D E F G H I J K L))))
(assert (forall ((K Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (M Int)
         (L Int))
  (=> (and (= K 2) (h8 A B C D E F G H I J M L)) (h7 A B C D E F G H I J K L))))
(assert (forall ((I Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (K Int)
         (L Int))
  (=> (and (= I 0) (h5 A B C D E F G H M J K L)) (h9 A B C D E F G H I J K L))))
(assert (forall ((I Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (K Int)
         (L Int))
  (=> (and (= I 0) (h7 A B C D E F G H M J K L)) (h9 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((A Int)
         ...
         (K Int)
         (L Int))
  (=> (h10 A B C D E F G H I J K L) (h11 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (K Int)
         (L Int))
  (=> (h11 A B C D E F G H I J K L) (h12 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((G Int)
         ...
         (K Int)
         (L Int))
  (=> (and (>= (- G I) 0) (h13 A B C D E F G H I J K L))
...
(assert (forall ((M Int)
  ...
  (let ((a!1 (and (= M (+ (- 1) I))
    ...
    (=> a!1 (h15 A B C D E F G H I J K L)))))
(assert (forall ((G Int)
         (I Int)
         (A Int)
         (B Int)
         ...
         (K Int)
         (L Int))
  (=> (and (<= (- G I) (- 1)) (h13 A B C D E F G H I J K L))
...
(assert (forall ((H Int)
         ...
         (K Int)
         (L Int))
  (=> (and (= H 1) (h19 A B C D E F G H I J K L)) (h20 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((H Int)
         ...
         (K Int)
         (L Int))
  (=> (and (<= H 0) (h19 A B C D E F G H I J K L))
...
(assert (forall ((L Int)
         ...
         (K Int)
         (M Int))
  (=> (and (= L 0) (h22 A B C D E F G H I J K M)) (h23 A B C D E F G H I J K L))))
(assert (forall ((H Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (K Int)
         (L Int))
  (=> (and (>= H 2) (h19 A B C D E F G H I J K L))
...
(assert (forall ((L Int)
         ...
         (K Int)
         (M Int))
  (=> (and (= L 0) (h24 A B C D E F G H I J K M)) (h23 A B C D E F G H I J K L))))
(assert (forall ((I Int)
         (J Int)
         (A Int)
         (B Int)
         ...
         (K Int)
         (L Int))
  (=> (and (>= (- I J) 1) (h21 A B C D E F G H I J K L))
...
(assert (forall ((A Int)
         ...
         (K Int)
         (L Int))
  (=> (h25 A B C D E F G H I J K L) false)))
(assert (forall ((I Int)
         (J Int)
         (A Int)
         (B Int)
...
(assert (forall ((A Int)
         ...
         (K Int)
         (L Int))
  (=> (h26 A B C D E F G H I J K L) false)))
(assert (forall ((I Int)
         (J Int)
         (A Int)
         (B Int)
         ...
         (K Int)
         (L Int))
  (=> (and (= I J) (h21 A B C D E F G H I J K L)) (h27 A B C D E F G H I J K L))))
(assert (forall ((L Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (K Int)
         (M Int))
  (=> (and (= L 0) (h27 A B C D E F G H I J K M)) (h23 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (K Int)
         (L Int))
  (=> (h23 A B C D E F G H I J K L) (h28 A B C D E F G H I J K L))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (K Int)
         (L Int))
  (=> (h28 A B C D E F G H I J K L) (h29 A B C D E F G H I J K L))))
(check-sat)
