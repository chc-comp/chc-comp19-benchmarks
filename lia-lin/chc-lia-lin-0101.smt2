...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!1 (or (= call_voiture.xite3__AT0 0)
        ...
        (a!2 (or (and (<= 0 speed__AT0)
                      (not (<= 4 speed__AT0))
                      (not (<= 11 dist__AT0))
                      (<= 0 dist__AT0))
                 (not env__AT0)))
        (a!3 (= call_Sofar.flby__AT0
                (and call_excludes2.excludes__AT0 (not (<= 32767 dist__AT0))))))
  (let ((a!4 (and (= call_Sofar.flby__AT0 call_Sofar.Sofar__AT0)
  ...
  (let ((a!1 (or (= call_voiture.xite3__AT0 0)
        ...
        (a!5 (= call_Sofar.flby__AT1
                (and call_Sofar.Sofar__AT0
                     ...
                     (not (<= 32767 dist__AT1)))))
        (a!6 (= (+ call_voiture.time__AT0 (* (- 1) call_voiture.xite4__AT1))
                (- 1)))
        (a!7 (= (+ call_voiture.dist__AT0 (* (- 1) call_voiture.xite__AT1))
                (- 1))))
  (let ((a!8 (and (state call_Sofar.flby__AT0
                         call_Sofar.Sofar__AT0
                         param_s__AT0
                         param_m__AT0
                         call_excludes2.excludes__AT0
                  ...
                  (or (not call_voiture.second__AT1) a!6)
