...
(assert (forall ((F Int)
         ...
         (I Int)
         (J Int))
  (=> (and (= F 0) (= G 0) (h1 A B C D E K L H I J)) (h2 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h6 A B C D E F G H I J) (h7 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h7 A B C D E F G H I J) (h8 A B C D E F G H I J))))
(assert (forall ((J Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (H Int)
         (I Int))
  (=> (and (<= J (- 1)) (h8 A B C D E F G H I J)) (h9 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((J Int)
         ...
         (H Int)
         (I Int))
  (=> (and (>= J 1) (h8 A B C D E F G H I J)) (h11 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h11 A B C D E F G H I J) (h10 A B C D E F G H I J))))
(assert (forall ((J Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (H Int)
         (I Int))
  (=> (and (= J 0) (h8 A B C D E F G H I J)) (h12 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h10 A B C D E F G H I J) (h15 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((I Int)
         ...
         (H Int)
         (J Int))
  (=> (and (<= I (- 1)) (h16 A B C D E F G H I J)) (h17 A B C D E F G H I J))))
(assert (forall ((K Int)
         (F Int)
         (L Int)
         (G Int)
...
(assert (forall ((I Int)
         ...
         (H Int)
         (J Int))
  (=> (and (>= I 1) (h16 A B C D E F G H I J)) (h19 A B C D E F G H I J))))
(assert (forall ((K Int)
         (F Int)
         (L Int)
         (G Int)
...
(assert (forall ((I Int)
         ...
         (H Int)
         (J Int))
  (=> (and (= I 0) (h16 A B C D E F G H I J)) (h20 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h18 A B C D E F G H I J) (h5 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h21 A B C D E F G H I J) (h22 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h22 A B C D E F G H I J) (h23 A B C D E F G H I J))))
(assert (forall ((H Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= H (- 1)) (h23 A B C D E F G H I J)) (h24 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h24 A B C D E F G H I J) (h25 A B C D E F G H I J))))
(assert (forall ((H Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= H 1) (h23 A B C D E F G H I J)) (h26 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h26 A B C D E F G H I J) (h25 A B C D E F G H I J))))
(assert (forall ((H Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (= H 0) (h23 A B C D E F G H I J)) (h27 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h27 A B C D E F G H I J) (h5 A B C D E F G H I J))))
(assert (forall ((F Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= F 4) (h25 A B C D E F G H I J)) (h28 A B C D E F G H I J))))
(assert (forall ((K Int)
         (F Int)
         (L Int)
         (G Int)
         ...
         (I Int)
         (J Int))
  (let ((a!1 (and (= K (+ (- 1) F)) (= L (+ (- 1) G)) (h28 A B C D E K L H I J))))
...
(assert (forall ((F Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= F 3) (h25 A B C D E F G H I J)) (h30 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h30 A B C D E F G H I J) (h31 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h29 A B C D E F G H I J) (h31 A B C D E F G H I J))))
(assert (forall ((F Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= F (- 1)) (h31 A B C D E F G H I J)) (h32 A B C D E F G H I J))))
(assert (forall ((K Int)
         (G Int)
         (A Int)
         (B Int)
         ...
         (I Int)
         (J Int))
  (=> (and (= K (+ 1 G)) (h32 A B C D E F K H I J)) (h33 A B C D E F G H I J))))
(assert (forall ((F Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= F 0) (h31 A B C D E F G H I J)) (h34 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h34 A B C D E F G H I J) (h5 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h33 A B C D E F G H I J) (h5 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h14 A B C D E F G H I J) (h35 A B C D E F G H I J))))
(assert (forall ((F Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= F 3) (h35 A B C D E F G H I J)) (h36 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((F Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= F 4) (h35 A B C D E F G H I J)) (h38 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h38 A B C D E F G H I J) (h39 A B C D E F G H I J))))
(assert (forall ((G Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= G 3) (h39 A B C D E F G H I J)) (h40 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h40 A B C D E F G H I J) (h37 A B C D E F G H I J))))
(assert (forall ((G Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= G 2) (h39 A B C D E F G H I J)) (h41 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h37 A B C D E F G H I J) (h42 A B C D E F G H I J))))
(check-sat)
