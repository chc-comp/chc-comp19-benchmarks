...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!7 (and (= call_First.flby__AT0 call_First.First__AT0)
...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!33 (and (state call_First.flby__AT0
                          call_First.First__AT0
                          call_Sofar.flby__AT0
                          call_Sofar.Sofar__AT0
                          param_e2__AT0
                   ...
                   (= (or a!12 (not env__AT1)) _OK___AT1)
                   (or param_e7__AT1
