;; Original file: chc-lia-0194.smt2
(set-logic HORN)
...
(assert
  ...
  (and (= J a!1)
       ...
       (= X (+ 176 Y))
       (= Q X)
       (or (not O2) (and W1 V1) (and O2 L1) (and O2 Q1) (and C2 B2))
       (or (not U) (not (<= X 0)) (<= Y 0))
       (or (not D) E (not B2))
       (or (not L1) (not V) (not U))
       (or (not C2) (not B2) (= J2 A2))
       (or (not C2) (not B2) (= H2 Y1))
       (or (not C2) (not B2) (= E2 D2))
       (or (not C2) (not B2) (= I2 Z1))
       (or (not O2) (not Q1) (= J2 P1))
       (or (not O2) (not Q1) (= H2 N1))
       (or (not O2) (not Q1) (= E2 R1))
       (or (not O2) (not Q1) (= I2 O1))
       (or (not O2) (not Y2) (= S2 N2))
       (or (not O2) (not Y2) (= T2 P2))
       (or (not O2) (not Y2) (= Q2 L2))
       (or (not O2) (not Y2) (= R2 M2))
       ...
       (or (not W1) (not V1) (= J2 U1))
       (or (not W1) (not V1) (= H2 S1))
       (or (not W1) (not V1) (= E2 X1))
       (or (not W1) (not V1) (= I2 T1))
       (or (not W1) D1 (not V1))
       (or (not O) (<= Y 0) (not (<= L 0)))
       (or (not O) (not D1) (not V1))
       (or (not O) P (not U))
       (or (not O) (not P) (not Q1))
       (or (not E1) (not B2) (not V1))
       (or E1 (not C2) (not B2))
       (or (not U) (not (<= Y 0)))
       (or (not U) (and O U))
       (or (not V1) (and B2 V1))
...
(assert
  ...
  (and (= U a!1)
       ...
       (or (not V) (not (<= R 0)) (<= X 0))
       (or W (not V) (not G1))
       (or (not O) (not (<= K 0)) (<= X 0))
...
(assert
  ...
  (and (= M (not (<= K1 Q1)))
       ...
       (= D2 L1)
       (not (<= B 0))
       (or (not T2) (and V1 U1) (and F2 E2) (and K2 J2) (and O2 P2) (and Z1 A2))
       (or (not Z1) (<= E1 0) (not (<= B1 0)))
       (or (not Z1) (not (<= Y 0)) (<= E1 0))
       (or (not Z1) (not (<= Z 0)) (<= E1 0))
       (or (not Z1) (not (<= A1 0)) (<= E1 0))
       (or (not Z1) (not (<= D1 0)) (<= E1 0))
       (or (not Z1) (not A2) (= X2 B2))
       (or (not Z1) (not A2) (= W2 Y1))
       (or (not Z1) (not A2) (= V2 X1))
       (or (not O2) (<= E 0) (not (<= D 0)))
       (or (not O2) (not P2) (= X2 Q2))
       (or (not O2) (not P2) (= W2 N2))
       (or (not O2) (not P2) (= V2 M2))
       (or O1 (not O2) (not P2))
       (or (not E2) (and V U) (and Q R))
       (or (not K2) (not J2) (= X2 L2))
       (or (not K2) (not J2) (= W2 I2))
       (or (not K2) (not J2) (= V2 H2))
       (or (not T2) (not B3) (not U2))
       (or (not Q) (not R) (= M1 S))
       (or (not Q) (not R) (= L1 P))
       (or (not Q) (not R) M)
       (or (not U) (<= E1 0) (not (<= I 0)))
       (or (not U) (<= E1 0) (not (<= K 0)))
       (or (not U) (not (<= H 0)) (<= E1 0))
       (or (not U) (not (<= J 0)) (<= E1 0))
       (or (not U) (not (<= L 0)) (<= E1 0))
       (or (not U) (not O1) (not O2))
       (or (not V) (not U) (= M1 W))
       (or (not V) (not U) (= L1 T))
       (or (not N3) (not X3) (= R3 M3))
       (or (not N3) (not X3) (= S3 O3))
       (or (not N3) (not X3) (= P3 K3))
       (or (not N3) (not X3) (= Q3 L3))
       (or (not N3) (not B3) (= I3 A3))
       (or (not N3) (not B3) (= G3 Y2))
       (or (not N3) (not B3) (= D3 C3))
       (or (not N3) (not B3) (= H3 Z2))
       (or (not F2) (not E2) (= X2 G2))
       (or (not F2) (not E2) (= W2 D2))
       (or (not F2) (not E2) (= V2 C2))
       (or O (not U) (not Q))
       (or (not O) (not V) (not U))
       (or (not W3) (not X3) (= B4 V3))
       (or (not W3) (not X3) (= Z3 T3))
       (or (not W3) (not X3) (= A4 U3))
       (or (not W3) (not X3) (= C4 Y3))
       (or (not J1) (not E2) (not Z1))
       (or J1 (not F2) (not E2))
       (or (not N1) (not J2) (not O2))
       (or N1 (not K2) (not J2))
       (or (not V1) (not U1) (= X2 W1))
       (or (not V1) (not U1) (= W2 T1))
       (or (not V1) (not U1) (= V2 S1))
       (or (not V1) F1 (not U1))
...
(assert
  ...
  (and (= F1 (not K1))
       ...
       (= I1 (+ 1 N1))
       (not (<= H3 0))
       (or (not Z2) (and S1 T1) (and I2 H2) (and C2 D2) (and Y1 X1) (and M2 N2))
       (or (not X1) (<= G3 0) (not (<= A1 0)))
       (or (not X1) (<= G3 0) (not (<= X 0)))
       (or (not X1) (<= G3 0) (not (<= Y 0)))
       (or (not X1) (<= G3 0) (not (<= Z 0)))
       (or (not X1) (<= G3 0) (not (<= C1 0)))
       (or (not M2) (<= D 0) (not (<= C 0)))
       (or (not M2) (not N2) (= T2 O2))
       (or (not M2) (not N2) (= R2 K2))
       (or (not M2) (not N2) (= S2 L2))
       ...
       (or (not T) (not U) (= K1 V))
       (or (not T) (not U) (= J1 S))
       (or (not T) (not U) (not N))
       (or (not P) (not T) N)
       (or (not Y1) (not X1) (= T2 Z1))
       (or (not Y1) (not X1) (= R2 V1))
       (or (not Y1) (not X1) (= S2 W1))
       (or (not Y1) (not F1) (not X1))
       (or M1 (not M2) (not N2))
       (or (not M1) (not T) (not M2))
       (or (not C2) (and Q P) (and T U))
       (or (not C2) (not H1) (not X1))
       ...
       (or (not Q) (not P) (= J1 O))
       (or (not Q) (not P) L)
       (or (not I2) (not H2) (= T2 J2))
       (or (not I2) (not H2) (= R2 F2))
       (or (not I2) (not H2) (= S2 G2))
       (or (not L1) (not H2) (not M2))
       (or L1 (not I2) (not H2))
       (or (not S1) F1 (not X1))
       (or (not S1) (not T1) (= T2 U1))
       (or (not S1) (not T1) (= R2 Q1))
       (or (not S1) (not T1) (= S2 R1))
       (or (not S1) D1 (not T1))
       (or (<= H3 0) (not (<= A 0)))
       (or (not X1) (not (<= G3 0)))
       (or (not X1) (and C2 X1))
...
(assert
  (forall ( (A Int) (B Int) (C Int) (D Int) (E Int) (F Bool) (G Bool) (H Int) (I Int) (J Int) (K Bool) (L Bool) (M Int) (N Int) (O Int) (P Int) (Q Int) (R Int) (S Int) (T Int) (U Bool) (V Int) (W Bool) (X Int) (Y Bool) (Z Int) (A1 Bool) (B1 Bool) (C1 Bool) (D1 Int) (E1 Bool) (F1 Bool) (G1 Bool) (H1 Int) (I1 Bool) (J1 Bool) (K1 Int) (L1 Int) (M1 Int) (N1 Int) (O1 Int) (P1 Int) (Q1 Int) (R1 Int) (S1 Bool) (T1 Bool) (U1 Bool) (V1 Int) (W1 Int) (X1 Int) (Y1 Bool) (Z1 Bool) (A2 Bool) (B2 Bool) (C2 Bool) (D2 Bool) ) 
    (=>
     ...
     (= T (+ 32 R1 (* 136 P1)))
     (not (<= D 0))
     (or (not I1) (and E1 F1) (and B1 A1))
     (or (not T1) (<= R1 0) (not (<= M1 0)))
     (or (not T1) (<= R1 0) (not (<= K1 0)))
     (or (not T1) (<= R1 0) (not (<= N1 0)))
     (or (not T1) (not (<= O1 0)) (<= R1 0))
     (or (not T1) (not (<= Q1 0)) (<= R1 0))
     (or (not T1) (not Y1) U1)
     (or (not T1) (not J1) (not I1))
     (or (not K) (<= I 0) (not (<= H 0)))
     (or (not B1) (not A1) (= S1 C1))
     (or (not B1) (not A1) (= X1 Z))
     (or (not B1) (not A1) U)
     (or (not Z1) (not A2) (not Y1))
     (or (not C2) (and B2 C2) (and C2 A2))
     (or (not B2) (not A1) (not U))
     (or (not E1) (<= R1 0) (not (<= R 0)))
     (or (not E1) (<= R1 0) (not (<= O 0)))
     (or (not E1) (<= R1 0) (not (<= S 0)))
     (or (not E1) (<= R1 0) (not (<= Q 0)))
     (or (not E1) (not (<= T 0)) (<= R1 0))
     (or (not E1) (not A1) W)
     (or (not E1) (not F1) (= S1 G1))
     (or (not E1) (not F1) (= X1 D1))
     (or (not E1) (not F1) (not W))
     (or (not E1) (not L) (not K))
     (or (not G) (not F) (not K))
     (or (<= D 0) (not (<= C 0)))
     (or (not D2) (and C2 D2))
     (or (not Y1) (and T1 Y1))
     (or (not A1) (and E1 A1))
