...
(assert (forall ((D Int) (A Int) (B Int) (C Int) (E Int))
  (=> (and (= D 0) (h1 A B C E)) (h2 A B C D))))
...
(assert (forall ((C Int) (D Int) (A Int) (B Int))
  (=> (and (>= (- C D) 1) (h6 A B C D)) (h7 A B C D))))
(assert (forall ((E Int) (D Int) (A Int) (B Int) (C Int))
  (let ((a!1 (and (= E (+ (- 1) D)) (h7 A B C E))))
    (=> a!1 (h8 A B C D)))))
(assert (forall ((C Int) (D Int) (A Int) (B Int))
  (=> (and (<= (- C D) 0) (h6 A B C D)) (h9 A B C D))))
...
(assert (forall ((C Int) (A Int) (B Int) (D Int))
  (=> (and (>= C 1) (h12 A B C D)) (h13 A B C D))))
(assert (forall ((A Int) (B Int) (C Int) (D Int)) (=> (h13 A B C D) (h14 A B C D))))
(assert (forall ((C Int) (A Int) (B Int) (D Int))
  (=> (and (<= C 0) (h12 A B C D)) (h15 A B C D))))
(assert (forall ((A Int) (B Int) (C Int) (D Int)) (=> (h15 A B C D) (h16 A B C D))))
(assert (forall ((C Int) (D Int) (A Int) (B Int))
  (=> (and (>= (- C D) 1) (h14 A B C D)) (h17 A B C D))))
(assert (forall ((A Int) (B Int) (C Int) (D Int)) (=> (h17 A B C D) false)))
(assert (forall ((C Int) (D Int) (A Int) (B Int))
  (=> (and (<= (- C D) (- 1)) (h14 A B C D)) (h18 A B C D))))
(assert (forall ((A Int) (B Int) (C Int) (D Int)) (=> (h18 A B C D) false)))
(assert (forall ((C Int) (D Int) (A Int) (B Int))
  (=> (and (= C D) (h14 A B C D)) (h19 A B C D))))
