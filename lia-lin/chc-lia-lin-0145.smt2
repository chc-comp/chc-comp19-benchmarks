...
(assert (forall ((call_PosEdge4.flby__AT0 Bool)
         ...
         (call__main_.call_one_button_accept.call_AtLeastOnceSince.xite__AT0 Bool)
  ...
  (let ((a!2 (and (= call_PosEdge4.flby__AT0 call_PosEdge4._Y___AT0)
...
(assert (forall ((call_PosEdge4.flby__AT0 Bool)
  ...
  (let ((a!1 (or (and (not param_ccsetd__AT0)
        ...
        (a!2 (= (or (and (not param_ccsetd__AT1)
                         param_ccseti__AT1
                         (not param_ccr__AT1))
        ...
        (a!3 (= call__main_.call_one_button_accept.call_prev_no_button.flby__AT1
                (and (not param_ccr__AT0)
                     (and (not param_ccsetd__AT0) (not param_ccseti__AT0)))))
        (a!4 (or (not (and call__main_.call_PosEdge2._Y___AT1
                           (not call__main_.ccont__AT0)))
                 call__main_.xite__AT1))
        (a!5 (or (not call__main_.xite2__AT1)
                 (not (or (and call__main_.ccont__AT0
                               call__main_.call_PosEdge._Y___AT1)
                          call__main_.call_Edge._Y___AT1
                          param_ccd__AT1)))))
  (let ((a!6 (and (state call_PosEdge4.flby__AT0
                         call_PosEdge4._Y___AT0
                         call_PosEdge3.flby__AT0
                         call_PosEdge3._Y___AT0
                         call_PosEdge2.flby__AT0
                  ...
                  (= call_PosEdge.flby__AT1 (and cca__AT1 (not cca__AT0)))
                  (= call__main_.call_one_button_accept.call_AtLeastOnceSince.flby__AT1
