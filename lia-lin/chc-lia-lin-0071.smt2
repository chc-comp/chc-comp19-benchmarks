...
(assert (forall ((F Int)
         ...
         (N Int)
         (J Int))
  (=> (and (= F 0) (= G 0) (= H 0) (= I 0) (h1 A B C D E K L M N J))
...
(assert (forall ((K Int)
         ...
         (I Int)
         (J Int))
  (let ((a!1 (and (= K (+ (- 1) F)) (h15 A B C D E K G H I J))))
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h10 A B C D E F G H I J) (h17 A B C D E F G H I J))))
(assert (forall ((K Int)
         (G Int)
         (L Int)
         (H Int)
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h10 A B C D E F G H I J) (h19 A B C D E F G H I J))))
(assert (forall ((K Int)
         (G Int)
         (L Int)
         (H Int)
...
(assert (forall ((A Int)
         ...
         (I Int)
         (J Int))
  (=> (h14 A B C D E F G H I J) (h20 A B C D E F G H I J))))
(assert (forall ((F Int)
         (G Int)
         (A Int)
         (B Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= (- F G) (- 1)) (h20 A B C D E F G H I J))
...
(assert (forall ((F Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= (- F G) 1) (h20 A B C D E F G H I J)) (h22 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((F Int)
         ...
         (I Int)
         (J Int))
  (=> (and (= F G) (h20 A B C D E F G H I J)) (h23 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h23 A B C D E F G H I J) (h24 A B C D E F G H I J))))
(assert (forall ((G Int)
         (H Int)
         (A Int)
         (B Int)
         ...
         (I Int)
         (J Int))
  (=> (and (<= (- G H) (- 1)) (h24 A B C D E F G H I J))
...
(assert (forall ((G Int)
         ...
         (I Int)
         (J Int))
  (=> (and (>= (- G H) 1) (h24 A B C D E F G H I J)) (h26 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((G Int)
         ...
         (I Int)
         (J Int))
  (=> (and (= G H) (h24 A B C D E F G H I J)) (h27 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h27 A B C D E F G H I J) (h28 A B C D E F G H I J))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (I Int)
         (J Int))
  (=> (h28 A B C D E F G H I J) (h29 A B C D E F G H I J))))
(check-sat)
