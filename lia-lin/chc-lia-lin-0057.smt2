...
(assert (forall ((E Int)
         ...
         (G Int)
         (H Int))
  (=> (and (= E F) (h7 A B C D E I G H)) (h8 A B C D E F G H))))
(assert (forall ((E Int) (H Int) (A Int) (B Int) (C Int) (D Int) (F Int) (G Int))
  (=> (and (>= (- E H) 0) (h6 A B C D E F G H)) (h9 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h9 A B C D E F G H) (h10 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h10 A B C D E F G H) (h11 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h8 A B C D E F G H) (h12 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h12 A B C D E F G H) (h13 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h13 A B C D E F G H) (h14 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h14 A B C D E F G H) (h15 A B C D E F G H))))
(assert (forall ((F Int) (H Int) (A Int) (B Int) (C Int) (D Int) (E Int) (G Int))
  (=> (and (<= (- F H) (- 1)) (h15 A B C D E F G H)) (h16 A B C D E F G H))))
(assert (forall ((F Int)
         (G Int)
         (A Int)
         (B Int)
         ...
         (I Int)
         (H Int))
  (=> (and (= F G) (h16 A B C D E F I H)) (h17 A B C D E F G H))))
(assert (forall ((F Int) (H Int) (A Int) (B Int) (C Int) (D Int) (E Int) (G Int))
  (=> (and (>= (- F H) 0) (h15 A B C D E F G H)) (h18 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h18 A B C D E F G H) (h19 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h19 A B C D E F G H) (h20 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h17 A B C D E F G H) (h21 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h21 A B C D E F G H) (h22 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h22 A B C D E F G H) (h23 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h23 A B C D E F G H) (h24 A B C D E F G H))))
(assert (forall ((G Int) (H Int) (A Int) (B Int) (C Int) (D Int) (E Int) (F Int))
  (=> (and (<= (- G H) (- 1)) (h24 A B C D E F G H)) (h25 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h25 A B C D E F G H) (h26 A B C D E F G H))))
(assert (forall ((G Int) (H Int) (A Int) (B Int) (C Int) (D Int) (E Int) (F Int))
  (=> (and (>= (- G H) 0) (h24 A B C D E F G H)) (h27 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h27 A B C D E F G H) (h28 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h28 A B C D E F G H) (h29 A B C D E F G H))))
(assert (forall ((E Int) (G Int) (A Int) (B Int) (C Int) (D Int) (F Int) (H Int))
  (=> (and (>= (- E G) 1) (h26 A B C D E F G H)) (h30 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h30 A B C D E F G H) false)))
(assert (forall ((E Int) (G Int) (A Int) (B Int) (C Int) (D Int) (F Int) (H Int))
  (=> (and (<= (- E G) 0) (h26 A B C D E F G H)) (h31 A B C D E F G H))))
(assert (forall ((I Int)
         (G Int)
         (A Int)
         (B Int)
         ...
         (F Int)
         (H Int))
  (let ((a!1 (and (= I (+ (- 1) G)) (h31 A B C D E F I H))))
    (=> a!1 (h32 A B C D E F G H)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h32 A B C D E F G H) (h23 A B C D E F G H))))
(assert (forall ((I Int)
         (F Int)
         (A Int)
         (B Int)
         ...
         (G Int)
         (H Int))
  (let ((a!1 (and (= I (+ (- 1) F)) (h29 A B C D E I G H))))
    (=> a!1 (h33 A B C D E F G H)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h33 A B C D E F G H) (h14 A B C D E F G H))))
(assert (forall ((I Int)
         (E Int)
         (A Int)
         (B Int)
         ...
         (G Int)
         (H Int))
  (let ((a!1 (and (= I (+ (- 1) E)) (h20 A B C D I F G H))))
    (=> a!1 (h34 A B C D E F G H)))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h34 A B C D E F G H) (h5 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h11 A B C D E F G H) (h35 A B C D E F G H))))
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (=> (h35 A B C D E F G H) (h36 A B C D E F G H))))
(check-sat)
