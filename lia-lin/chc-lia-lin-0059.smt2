...
(assert (forall ((A Int) (B Int) (C Int) (D Int) (E Int) (F Int) (G Int) (H Int))
  (let ((a!1 (not (>= (+ C (- 1)) 0))))
    (=> (and (not (= A B)) a!1 (= D 0) (INV1 C A E F D B G H) (= G H)) false))))
