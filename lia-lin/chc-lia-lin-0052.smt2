...
(assert (forall ((call_Store.flby__AT0 Int)
         ...
         (Total__AT0 Int)
         (_OK___AT0 Bool))
  (let ((a!1 (= (and call_Sofar.flby__AT0
                     (<= param_Delta__AT0 1)
                     (<= (- 1) param_Delta__AT0))
                call_Sofar._Y___AT0))
        (a!2 (or (= call_Store.xite2__AT0 call_Store.xite__AT0)
                 (and (not (<= call_Store.Prev__AT0 0))
                      (not (<= 0 param_Delta__AT0)))))
        (a!3 (not (and (not (<= call_Store.Prev__AT0 0))
                       (not (<= 0 param_Delta__AT0)))))
...
(assert (forall ((call_Store.flby__AT0 Int)
  ...
  (let ((a!1 (= (and call_Sofar.flby__AT0
        ...
        (a!8 (= (or (and (<= Total__AT0 20) (<= 0 Total__AT0))
                    (not call_Sofar._Y___AT0))
                _OK___AT0))
        (a!9 (= (and (<= param_Delta__AT1 1)
                     (<= (- 1) param_Delta__AT1)
                     call_Sofar.flby__AT1)
                call_Sofar._Y___AT1))
        (a!10 (or (= call_Store.xite2__AT1 call_Store.xite__AT1)
                  (and (not (<= call_Store.Prev__AT1 0))
                       (not (<= 0 param_Delta__AT1)))))
        (a!11 (not (and (not (<= call_Store.Prev__AT1 0))
                        (not (<= 0 param_Delta__AT1)))))
