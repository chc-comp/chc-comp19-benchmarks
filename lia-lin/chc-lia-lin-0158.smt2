...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!1 (and (and (and (not param_e2__AT0) (not param_e1__AT0))
        ...
        (a!6 (or (<= 3 call_ticket3i.p3__AT0)
                 (<= 3 call_ticket3i.p2__AT0)
                 (<= 3 call_ticket3i.p1__AT0))))
  ...
  (let ((a!7 (and (= call_Sofar.flby__AT0 call_Sofar.Sofar__AT0)
                  ...
                  (or param_e7__AT0
                      (= call_ticket3i.xite19__AT0 call_ticket3i.xite18__AT0))
                  ...
                  (= (or (not erreur_ticket3i__AT0) (not call_Sofar.Sofar__AT0))
                     _OK___AT0)
...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!19 (and (state call_Sofar.flby__AT0
                   ...
                   (or param_e8__AT0
                       (= call_ticket3i.xite18__AT0 call_ticket3i.xite17__AT0))
                   (= call_ticket3i.p1__AT0 p1__AT0)
                   (= (or (not erreur_ticket3i__AT0)
                          (not call_Sofar.Sofar__AT0))
                      _OK___AT0)
                   ...
                   (or param_e7__AT1
                       (= call_ticket3i.xite19__AT1 call_ticket3i.xite18__AT1))
                   ...
                   (or (not param_e8__AT1)
                       (= call_ticket3i.xite18__AT1 call_ticket3i.xite15__AT1))
                   (or param_e8__AT1
                       (= call_ticket3i.xite18__AT1 call_ticket3i.xite17__AT1))
                   (= call_ticket3i.p1__AT1 p1__AT1)
                   (= (or (not erreur_ticket3i__AT1)
                          (not call_Sofar.Sofar__AT1))
                      _OK___AT1)
