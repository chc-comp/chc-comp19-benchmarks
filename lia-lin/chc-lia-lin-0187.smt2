...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!9 (and (= call_First.flby__AT0 call_First.First__AT0)
                  ...
                  (= (or (<= shared_dirty__AT0 call_First.First__AT0)
                         (not env__AT0))
                     _OK___AT0)
                  (or param_e08__AT0
...
(assert (forall ((call_First.flby__AT0 Int)
  ...
  (let ((a!1 (and (and (and (not param_e02__AT0) (not param_e01__AT0))
        ...
        (a!18 (= (and (<= 1 call__DRAGON_.invalid__AT0)
                      (<= 2
                          (+ call__DRAGON_.dirty__AT0
                             call__DRAGON_.shared_dirty__AT0
                             call__DRAGON_.shared__AT0
        ...
        (a!23 (= (+ call__DRAGON_.dirty__AT0
                 ...
                 (- 1)))
        (a!24 (= (+ call__DRAGON_.shared_dirty__AT0
        ...
        (a!25 (= (+ call__DRAGON_.dirty__AT0
                 ...
                 0))
        (a!26 (= (+ call__DRAGON_.shared__AT0
                    (* (- 1) call__DRAGON_.xite16__AT1))
                 1))
        (a!27 (= (+ call__DRAGON_.shared_dirty__AT0
                    call__DRAGON_.shared__AT0
        ...
        (a!28 (= (+ call__DRAGON_.dirty__AT0
                 ...
                 0))
        (a!29 (= (+ call__DRAGON_.shared__AT0
                    call__DRAGON_.exclusive__AT0
  ...
  (let ((a!41 (and (state call_First.flby__AT0
                          call_First.First__AT0
                          call_Sofar.flby__AT0
                          call_Sofar.Sofar__AT0
                          param_e02__AT0
                   ...
                   (= (or (<= shared_dirty__AT1 call_First.First__AT1)
                          (not env__AT1))
                      _OK___AT1)
                   (or param_e08__AT1
                   ...
                   (or a!19 (not call__DRAGON_.g09__AT1))
                   ...
                   (or a!23 (not call__DRAGON_.g03__AT1))
                   (or call__DRAGON_.g11__AT1
                       (= call__DRAGON_.shared_dirty__AT0
                          call__DRAGON_.xite26__AT1))
                   (or a!24 (not call__DRAGON_.g11__AT1))
                   (or call__DRAGON_.g08__AT1
                       (= call__DRAGON_.shared_dirty__AT0
