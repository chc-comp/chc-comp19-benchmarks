...
(assert (forall ((I Int)
         ...
         (O Int)
         (P Int))
  (=> (and (= I 0) (= K 0) (h1 A B C D E F G H Q J R L M N O P))
...
(assert (forall ((M Int)
         ...
         (O Int)
         (P Int))
  (=> (and (<= M (- 1)) (h8 A B C D E F G H I J K L M N O P))
...
(assert (forall ((Q Int)
         ...
         (O Int)
         (P Int))
  (let ((a!1 (and (= Q (+ (- 1) I)) (h9 A B C D E F G H Q J K L M N O P))))
    (=> a!1 (h10 A B C D E F G H I J K L M N O P)))))
(assert (forall ((M Int)
         (A Int)
         (B Int)
         (C Int)
...
(assert (forall ((Q Int)
         ...
         (O Int)
         (P Int))
  (let ((a!1 (and (= Q (+ (- 1) I)) (h11 A B C D E F G H Q J K L M N O P))))
    (=> a!1 (h10 A B C D E F G H I J K L M N O P)))))
(assert (forall ((M Int)
         (A Int)
         (B Int)
         ...
         (O Int)
         (P Int))
  (=> (and (= M 0) (h8 A B C D E F G H I J K L M N O P))
...
(assert (forall ((I Int)
         ...
         (O Int)
         (P Int))
  (=> (and (>= (- I J) 1) (h15 A B C D E F G H I J K L M N O P))
...
(assert (forall ((I Int)
         ...
         (O Int)
         (P Int))
  (=> (and (<= (- I J) 0) (h15 A B C D E F G H I J K L M N O P))
...
(assert (forall ((I Int)
         ...
         (O Int)
         (P Int))
  (=> (and (= I 0) (h18 A B C D E F G H Q J K L M N O P))
...
(assert (forall ((I Int)
         ...
         (O Int)
         (P Int))
  (=> (and (= I 0) (h17 A B C D E F G H Q J K L M N O P))
      (h19 A B C D E F G H I J K L M N O P))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
...
(assert (forall ((N Int)
         ...
         (O Int)
         (P Int))
  (=> (and (<= N (- 1)) (h25 A B C D E F G H I J K L M N O P))
...
(assert (forall ((Q Int)
  ...
  (let ((a!1 (and (= Q (+ (- 1) I))
    ...
    (=> a!1 (h27 A B C D E F G H I J K L M N O P)))))
(assert (forall ((N Int)
         (A Int)
         (B Int)
         (C Int)
...
(assert (forall ((N Int)
         ...
         (O Int)
         (P Int))
  (=> (and (= N 0) (h25 A B C D E F G H I J K L M N O P))
...
(assert (forall ((O Int)
         ...
         (N Int)
         (P Int))
  (=> (and (<= O (- 1)) (h37 A B C D E F G H I J K L M N O P))
...
(assert (forall ((O Int)
         ...
         (N Int)
         (P Int))
  (=> (and (= O 0) (h37 A B C D E F G H I J K L M N O P))
...
(assert (forall ((P Int)
         ...
         (O Int)
         (R Int))
  (=> (and (= P 0) (= I L) (h42 A B C D E F G H I J K Q M N O R))
...
(assert (forall ((K Int)
         ...
         (O Int)
         (P Int))
  (=> (and (<= K (- 1)) (h47 A B C D E F G H I J K L M N O P))
...
(assert (forall ((A Int)
         ...
         (O Int)
         (P Int))
  (=> (h48 A B C D E F G H I J K L M N O P) false)))
(assert (forall ((K Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (O Int)
         (P Int))
  (=> (and (>= K 0) (h47 A B C D E F G H I J K L M N O P))
...
(assert (forall ((Q Int)
  ...
  (let ((a!1 (and (= Q (+ 1 K))
    ...
    (=> a!1 (h50 A B C D E F G H I J K L M N O P)))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((L Int)
         ...
         (N Int)
         (O Int))
  (=> (and (>= (- L P) 1) (h51 A B C D E F G H I J K L M N O P))
...
(assert (forall ((L Int)
         ...
         (N Int)
         (O Int))
  (=> (and (<= (- L P) 0) (h51 A B C D E F G H I J K L M N O P))
      (h53 A B C D E F G H I J K L M N O P))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (P Int))
  (=> (h53 A B C D E F G H I J K L M N O P)
      (h54 A B C D E F G H I J K L M N O P))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (P Int))
  (=> (h54 A B C D E F G H I J K L M N O P)
      (h55 A B C D E F G H I J K L M N O P))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (P Int))
  (=> (h55 A B C D E F G H I J K L M N O P)
      (h56 A B C D E F G H I J K L M N O P))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
         ...
         (P Int))
  (=> (h56 A B C D E F G H I J K L M N O P)
      (h57 A B C D E F G H I J K L M N O P))))
(check-sat)
