...
(assert (forall ((state.elem!aba Int)
  ...
  (let ((a!6 (ite (= state.head!ptr 7)
        ...
        (a!23 (and (= state.pc_e 3)
                   ...
                   a!15
                   a!3))
        (a!26 (ite (= state.elem!ptr 7)
                   state.mem!6!ptr
                   (ite (= state.elem!ptr 6)
                        state.mem!5!ptr
                        (ite (= state.elem!ptr 5) state.mem!4!ptr a!25)))))
  (let ((a!7 (ite (= state.head!ptr 10)
        ...
        (a!27 (ite (= state.elem!ptr 10)
                   state.mem!9!ptr
                   (ite (= state.elem!ptr 9)
                        state.mem!8!ptr
                        (ite (= state.elem!ptr 8) state.mem!7!ptr a!26)))))
  (let ((a!12 (or (and (= state.pc_d 0)
        ...
        (a!22 (and (= state.pc_e 1)
                   ...
                   a!15
                   a!3))
        (a!28 (and (or (not (= state.pc_e 3))
                       (not (= next.pc_e 4))
                       (not (= a!27 state.last_o)))
                   (or (not (= state.pc_e 3))
                       (not (= next.pc_e 4))
                       (= a!27 state.last_o))
                   (or (not (= state.pc_d 2)) (not (= next.pc_d 3)))
                   (= next.last_o state.last_o)
                   (= next.ok_e state.ok_e))))
  (let ((a!24 (or (and (= state.pc_e 0)
                  ...
                  (and (= state.pc_e 4)
                       ...
                       a!3)))
        (a!29 (or (and (= state.pc_e 3)
                       (= next.pc_e 4)
                       (= a!27 state.last_o)
                       (= next.last_o state.elem!ptr)
                       (= next.ok_e true))
                  (and (= state.pc_e 3)
                       (= next.pc_e 4)
                       (not (= a!27 state.last_o))
                  ...
                  (and (= state.pc_d 2)
                       (= next.pc_d 3)
                       (= next.last_o state.next!ptr)
                       (= next.ok_e state.ok_e))
                  a!28)))
  (let ((a!30 (and (invariant state.elem!aba
                              state.elem!ptr
                              state.elem!val
                              state.head!aba
                              state.head!ptr
