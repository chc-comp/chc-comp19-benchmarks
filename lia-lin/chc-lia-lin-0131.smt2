...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!1 (= (not (or (and param_etat_me4__AT0 param_etat_me3__AT0)
        ...
        (a!2 (or (and (<= 0 exclusive_me__AT0)
                      (<= modified_me__AT0 2)
                      (or (<= shared_me__AT0 1) (<= modified_me__AT0 1)))
                 (not env__AT0))))
...
(assert (forall ((call_Sofar.flby__AT0 Bool)
  ...
  (let ((a!1 (= (not (or (and param_etat_me4__AT0 param_etat_me3__AT0)
        ...
        (a!4 (or (and (<= 0 exclusive_me__AT1)
                      (<= modified_me__AT1 2)
                      (or (<= shared_me__AT1 1) (<= modified_me__AT1 1)))
                 (not env__AT1)))
        (a!5 (= call_Sofar.flby__AT1
                (or call_Sofar.Sofar__AT0
                    (and call_excludes4.excludes__AT1 (<= 0 modified_me__AT1)))))
        (a!6 (= (+ call_mesi.invalid_me__AT0 (* (- 1) call_mesi.xite25__AT1)) 1))
        (a!7 (= (+ call_mesi.exclusive_me__AT0 (* (- 1) call_mesi.xite10__AT1))
                1))
        (a!8 (= (+ call_mesi.invalid_me__AT0
                ...
                1))
        (a!9 (= (+ call_mesi.invalid_me__AT0
                   call_mesi.shared_me__AT0
                   call_mesi.exclusive_me__AT0
                   call_mesi.modified_me__AT0
                   (* (- 1) call_mesi.xite27__AT1))
                1))
        (a!10 (= (+ call_mesi.shared_me__AT0
                    call_mesi.exclusive_me__AT0
                    call_mesi.modified_me__AT0
                    (* (- 1) call_mesi.xite17__AT1))
                 0))
        (a!11 (= (+ call_mesi.modified_me__AT0 (* (- 1) call_mesi.xite2__AT1))
                 1)))
    (=> (and (state call_Sofar.flby__AT0
                    call_Sofar.Sofar__AT0
                    param_etat_me4__AT0
                    param_etat_me3__AT0
                    param_etat_me2__AT0
             ...
             (or (= call_mesi.xite20__AT1 0) (not call_mesi.garde_me4__AT1))
             (or (not call_mesi.garde_me4__AT1) (= call_mesi.xite4__AT1 0))
             (or (not call_mesi.garde_me4__AT1) (= call_mesi.xite12__AT1 1))
             (= (<= 1 call_mesi.shared_me__AT0) call_mesi.garde_me3__AT1)
             (or (= call_mesi.xite19__AT1 0) (not call_mesi.garde_me3__AT1))
             (or (not call_mesi.garde_me3__AT1) (= call_mesi.xite3__AT1 0))
             (or (not call_mesi.garde_me3__AT1) (= call_mesi.xite11__AT1 1))
             (= (<= 1 call_mesi.exclusive_me__AT0) call_mesi.garde_me2__AT1)
             ...
             (or (not call_mesi.garde_me1__AT1) a!6)
             ...
             (or (not call_mesi.garde_me2__AT1) a!7)
             ...
             (or (not call_mesi.garde_me4__AT1) a!8)
             (or (not call_mesi.garde_me3__AT1) a!9)
             (or (not call_mesi.garde_me1__AT1) a!10)
             (or call_mesi.garde_me4__AT1
             ...
             (or (not call_mesi.garde_me2__AT1) a!11))
