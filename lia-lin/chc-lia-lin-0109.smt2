...
(assert (forall ((J Int)
  ...
  (let ((a!1 (and (= J (+ (- L) N))
    ...
    (=> a!1 (h10 A B C D E F G H I J K L M N O P Q R)))))
(assert (forall ((Q Int)
         (A Int)
         (B Int)
         (C Int)
...
(assert (forall ((S Int)
  ...
  (let ((a!1 (and (= S (+ (- 1) J))
    ...
    (=> a!1 (h17 A B C D E F G H I J K L M N O P Q R)))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
         (D Int)
...
(assert (forall ((S Int)
         ...
         (Q Int)
         (R Int))
  (=> (and (= S (+ 1 J)) (h18 A B C D E F G H I S K L M N O P Q R))
...
(assert (forall ((S Int)
         ...
         (Q Int)
         (R Int))
  (=> (and (= S (+ 1 J)) (h20 A B C D E F G H I S K L M N O P Q R))
      (h19 A B C D E F G H I J K L M N O P Q R))))
(assert (forall ((A Int)
         (B Int)
         (C Int)
...
(assert (forall ((P Int)
         ...
         (Q Int)
         (R Int))
  (=> (and (<= P (- 1)) (h26 A B C D E F G H I J K L M N O P Q R))
...
(assert (forall ((P Int)
         ...
         (Q Int)
         (R Int))
  (=> (and (= P 0) (h26 A B C D E F G H I J K L M N O P Q R))
...
(assert (forall ((J Int)
         ...
         (R Int))
  (let ((a!1 (<= (- (+ (- J K) L) M) (- 1))))
    (=> (and a!1 (h33 A B C D E F G H I J K L M N O P Q R))
...
(assert (forall ((A Int)
         ...
         (Q Int)
         (R Int))
  (=> (h34 A B C D E F G H I J K L M N O P Q R) false)))
(assert (forall ((J Int)
         (K Int)
         (L Int)
         (M Int)
...
(assert (forall ((A Int)
         ...
         (Q Int)
         (R Int))
  (=> (h35 A B C D E F G H I J K L M N O P Q R) false)))
(assert (forall ((J Int)
         (K Int)
         (L Int)
         (M Int)
         ...
         (Q Int)
         (R Int))
  (let ((a!1 (and (= J (+ (- K L) M)) (h33 A B C D E F G H I J K L M N O P Q R))))
    (=> a!1 (h36 A B C D E F G H I J K L M N O P Q R)))))
(assert (forall ((R Int)
         (A Int)
         (B Int)
         (C Int)
         ...
         (Q Int)
         (S Int))
  (=> (and (= R 0) (h36 A B C D E F G H I J K L M N O P Q S))
